...
- **Offre associée** : [[offres/plateforme-proxmox-docker|Bundle C — Plateforme Proxmox & Docker]] — Déploiement et industrialisation complets.
- **Preuve associée** : [[preuves/preuve-c1-proxmox-plateforme-stable|Preuve C1 — Proxmox plateforme stable]] — Segmentation, snapshots, backups, supervision sur lab.
