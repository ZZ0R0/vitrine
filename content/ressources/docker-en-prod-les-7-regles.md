...
- **Offre associée** : [[offres/plateforme-proxmox-docker|Bundle C — Plateforme Proxmox & Docker]] — Docker industrialisé, SSO, reverse proxy TLS.
- **Preuve associée** : [[preuves/preuve-c2-docker-portainer-ldap-sso|Preuve C2 — Docker industrialisé + SSO]] — Architecture complète déployée sur lab.
