...
Ces options complètent les [bundles principaux](/offres/) et peuvent être souscrites séparément (TJM ou forfait selon le périmètre).
...
**Références** : [Preuve T2 — Vuln management & patch cadence](/preuves/preuve-t2-vuln-management-patch-cadence)
...
**Références** : [Preuve T1 — Observabilité & SIEM-lite](/preuves/preuve-t1-observabilite-siem-lite)
...
**Références** : [Méthode PRA/PCA](/methodes/restauration-backup-pra) · [Preuve A2 — PRA/PCA minimal](/preuves/preuve-a2-pra-pca-minimal)
...
> **[Prendre contact pour un devis →](/à-propos/contact)**
